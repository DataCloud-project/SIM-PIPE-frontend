...
The front-end subcomponent will be integrated with the DEF-PIPE user interface and will use the same technologies for implementation (provisionally AngularJS and HTML). The specific interactions will be as follows:
